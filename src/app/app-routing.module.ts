...
const routes: Routes = [
  ...
  { path: '', loadChildren: './vault/vault.module#VaultPageModule' }, // vault
  { path: 'vault-created', loadChildren: './vault-created/vault-created.module#VaultCreatedPageModule' }, // vault-created
];
